...
I specialize in AI Security Assurance, evaluating how AI systems are tested, secured, and governed before deployment in real environments. My work covers the full lifecycle — from model intake and supply-chain verification through adversarial testing, RAG pipeline security, and agentic AI security assessment.
...
- LLM red teaming (Garak, PyRIT, Promptfoo — automated and manual)
- Jailbreak, prompt injection, and refusal-bypass evaluation
- RAG pipeline security — retrieval poisoning, context manipulation, jailbreak-through-retrieval
- Agentic AI security — tool call injection, goal hijacking, privilege escalation, indirect injection
...
End-to-end portfolio demonstrating a six-stage AI Security Assurance lifecycle:
